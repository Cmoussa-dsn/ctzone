        ...
        <div class="glass p-10 rounded-2xl shadow-lg text-center mb-8">
            ...
            <div class="flex justify-center gap-8 mt-8">
                <div class="flex flex-col items-center">
                    ...
                    <div class="text-green-700 font-bold text-xl"><?php echo e(\App\Models\Product::count()); ?></div>
                </div>
                <div class="flex flex-col items-center">
                    ...
                    <div class="text-indigo-700 font-bold text-xl"><?php echo e(\App\Models\Category::count()); ?></div>
                </div>
                <div class="flex flex-col items-center">
                    ...
                    <div class="text-gray-700 font-bold text-xl"><?php echo e(\App\Models\User::count()); ?></div>
                </div>
            </div>
        </div>
    </div>
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\charb\Downloads\modern_ct_zone (2)\modern_ct_zone\resources\views/admin/welcome.blade.php ENDPATH**/ ?>