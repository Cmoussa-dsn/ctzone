...
<?php $component->withAttributes([]); ?>
        ...
        <div class="container mx-auto px-6 py-24 md:py-32 relative z-10">
            <div class="max-w-3xl">
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="<?php echo e(route('mining.products')); ?>" class="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 rounded-lg text-white font-semibold transition duration-300">Browse Equipment</a>
                    <a href="<?php echo e(route('mining.calculator')); ?>" class="px-6 py-3 bg-white hover:bg-gray-100 rounded-lg text-indigo-700 font-semibold transition duration-300 flex items-center">
                        Mining Calculator
    ...
    <div class="container mx-auto px-6 py-16">
        ...
        <div class="text-center mt-8">
            <a href="<?php echo e(route('mining.products')); ?>" class="inline-block px-6 py-3 border border-indigo-600 hover:bg-indigo-50 rounded-lg text-indigo-600 font-semibold transition duration-300">View All Products</a>
        </div>
    </div>
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="mb-16">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="<?php echo e(route('mining.products')); ?>" class="text-indigo-600 hover:text-indigo-800 font-medium">View All</a>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <?php $__currentLoopData = $asicMiners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $miner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                        <div class="h-40 overflow-hidden">
                            <?php if($miner->image): ?>
                                <img src="<?php echo e(asset('storage/' . $miner->image)); ?>" alt="<?php echo e($miner->name); ?>" class="w-full h-full object-cover">
                            <?php else: ?>
                                <div class="w-full h-full bg-gray-200 flex items-center justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        ...
                        <div class="p-6">
                            <h4 class="text-lg font-bold mb-2"><?php echo e($miner->name); ?></h4>
                            <div class="flex items-center mb-2">
                                <span class="text-gray-700 font-medium mr-2">Hashrate:</span>
                                <span class="text-gray-600"><?php echo e($miner->hashrate); ?></span>
                            </div>
                            <div class="flex justify-between items-center mt-4">
            ...
            <div class="mb-16">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <?php $__currentLoopData = $gpuMiners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $miner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                        <div class="h-40 overflow-hidden">
                            <?php if($miner->image): ?>
                                <img src="<?php echo e(asset('storage/' . $miner->image)); ?>" alt="<?php echo e($miner->name); ?>" class="w-full h-full object-cover">
                    ...
                    <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                        <div class="h-40 overflow-hidden">
                            <?php if($accessory->image): ?>
                                <img src="<?php echo e(asset('storage/' . $accessory->image)); ?>" alt="<?php echo e($accessory->name); ?>" class="w-full h-full object-cover">
                            <?php else: ?>
                                <div class="w-full h-full bg-gray-200 flex items-center justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        ...
                        <div class="p-6">
                            <h4 class="text-lg font-bold mb-2"><?php echo e($accessory->name); ?></h4>
        ...
        <div class="bg-indigo-50 rounded-2xl overflow-hidden">
            <div class="flex flex-col md:flex-row">
                <div class="md:w-1/2 p-8 md:p-12">
                    ...
                    <a href="<?php echo e(route('mining.calculator')); ?>" class="inline-block px-6 py-3 bg-indigo-600 hover:bg-indigo-700 rounded-lg text-white font-semibold transition duration-300 flex items-center">
                        Try Calculator
                        <?php if(auth()->guard()->guest()): ?>
...
<?php endif; ?> <?php /**PATH C:\Users\charb\Downloads\modern_ct_zone (2)\modern_ct_zone\resources\views/mining/index.blade.php ENDPATH**/ ?>