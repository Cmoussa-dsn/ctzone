                        ...
                        <div class="p-6">
                            ...
                            <div class="flex justify-between items-center mt-4">
                                ...
                                <div class="flex items-center space-x-2">
                                    <button 
                                        onclick="quickAddToCart({{ $miner->id }})"
                                        class="p-2 bg-green-600 hover:bg-green-700 rounded-lg text-white transition duration-300 flex items-center justify-center {{ $miner->stock_quantity == 0 ? 'opacity-50 cursor-not-allowed' : '' }}"
                                        {{ $miner->stock_quantity == 0 ? 'disabled' : '' }}
                                        title="{{ $miner->stock_quantity == 0 ? 'Out of Stock' : 'Add to Cart' }}"
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
                                        </svg>
                    ...
                    <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex justify-between items-center mt-4">
                                ...
                                <div class="flex items-center space-x-2">
                                    <button 
                                        onclick="quickAddToCart({{ $accessory->id }})"
                                        class="p-2 bg-green-600 hover:bg-green-700 rounded-lg text-white transition duration-300 flex items-center justify-center {{ $accessory->stock_quantity == 0 ? 'opacity-50 cursor-not-allowed' : '' }}"
                                        {{ $accessory->stock_quantity == 0 ? 'disabled' : '' }}
                                        title="{{ $accessory->stock_quantity == 0 ? 'Out of Stock' : 'Add to Cart' }}"
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
                                        </svg>
