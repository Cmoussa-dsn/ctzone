                ...
                <div class="p-6">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <div class="flex items-center">
                            @if(isset($cryptoPrices['timestamp']))
                                <div class="text-sm text-blue-200 mr-4">Updated: {{ date('Y-m-d H:i:s', $cryptoPrices['timestamp']) }}</div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
                        <div class="bg-white bg-opacity-10 p-4 rounded-lg">
                            ...
                            <div class="text-xl font-bold text-white">${{ isset($cryptoPrices['BTC']) ? number_format($cryptoPrices['BTC'], 2) : '39,500.00' }}</div>
                        </div>
                        ...
                        <div class="bg-white bg-opacity-10 p-4 rounded-lg">
                            ...
                            <div class="text-xl font-bold text-white">${{ isset($cryptoPrices['ETH']) ? number_format($cryptoPrices['ETH'], 2) : '2,000.00' }}</div>
                        </div>
                        ...
                        <div class="bg-white bg-opacity-10 p-4 rounded-lg">
                            ...
                            <div class="text-xl font-bold text-white">${{ isset($cryptoPrices['LTC']) ? number_format($cryptoPrices['LTC'], 2) : '80.00' }}</div>
                        </div>
                        ...
                        <div class="bg-white bg-opacity-10 p-4 rounded-lg">
                            ...
                            <div class="text-xl font-bold text-white">${{ isset($cryptoPrices['DASH']) ? number_format($cryptoPrices['DASH'], 2) : '30.00' }}</div>
                        </div>
                        ...
                        <div class="bg-white bg-opacity-10 p-4 rounded-lg">
                            ...
                            <div class="text-xl font-bold text-white">${{ isset($cryptoPrices['XMR']) ? number_format($cryptoPrices['XMR'], 2) : '160.00' }}</div>
                        </div>
                    </div>
                    
                    @if(isset($cryptoPrices['is_fallback']))
                                ...
                                @foreach($miningProducts as $product)
                                    @if($product->hashrate != 'N/A')
                                        <option value="{{ $product->id }}" 
                                                data-hashrate="{{ str_replace(['TH/s', 'MH/s'], '', $product->hashrate) }}"
                                                data-power="{{ $product->power_consumption }}"
    ...
    <div class="bg-gray-50 py-12">
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                @foreach($miningProducts->where('featured', true)->take(4) as $product)
            ...
            <div class="text-center mt-8">
                <a href="{{ route('mining.products') }}" class="inline-block px-6 py-3 border border-indigo-600 hover:bg-indigo-50 rounded-lg text-indigo-600 font-semibold transition duration-300">Browse All Mining Products</a>
            </div>
        </div>
    </div>
