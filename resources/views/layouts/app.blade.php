                        ...
                        @auth
                            <div class="flex items-center space-x-4">
                                ...
                                @if(Auth::user()->isAdmin())
                                    <a href="{{ route('admin.dashboard') }}" class="text-gray-500 hover:text-indigo-600 transition duration-150">
                    ...
                    @auth
                        <div class="pt-4 pb-3 border-t border-gray-200">
                            ...
                            <div class="mt-3 space-y-1">
                                ...
                                @if(Auth::user()->isAdmin())
                                    <a href="{{ route('admin.dashboard') }}" class="block px-4 py-2 text-base font-medium text-gray-500 hover:text-gray-800 hover:bg-gray-100 focus:outline-none focus:text-gray-800 focus:bg-gray-100 transition duration-150 ease-in-out">Admin Dashboard</a>
                                @endif
