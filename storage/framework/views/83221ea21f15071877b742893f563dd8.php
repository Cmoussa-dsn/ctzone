...
<?php $component->withAttributes([]); ?>
            ...
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="w-full lg:w-2/3">
                    <div class="bg-white rounded-lg shadow-md p-6 mb-4">
                        <h2 class="text-xl font-semibold mb-4">Cart Items (<?php echo e($cartItems->count()); ?>)</h2>
                            ...
                            <?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex flex-col sm:flex-row py-4 items-center">
                                    <div class="w-full sm:w-24 h-24 mb-4 sm:mb-0">
                                        <?php if($item->product->type == 'custom_pc'): ?>
                                            <img src="<?php echo e(asset('images/default-pc.jpg')); ?>" 
                                                alt="<?php echo e($item->product->name); ?>" 
                                                class="w-full h-full object-cover rounded">
                                        <?php else: ?>
                                            <img src="<?php echo e($item->product->image ? asset('storage/' . $item->product->image) : asset('images/default-pc.jpg')); ?>" 
                                                alt="<?php echo e($item->product->name); ?>" 
                                                class="w-full h-full object-cover rounded">
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <div class="flex-1 px-4">
                                        ...
                                        <p class="text-gray-600 text-sm"><?php echo e(Str::limit($item->product->description, 60)); ?></p>
                                        
                                        <?php if($item->product->type == 'custom_pc' && session()->has('custom_pc')): ?>
                                            <div class="mt-2 text-xs text-gray-500">
                                                <p>Custom PC with selected components</p>
                                            </div>
                                        <?php endif; ?>
                                        
                                        <p class="text-indigo-600 font-semibold mt-1">$<?php echo e(number_format($item->product->price, 2)); ?></p>
                                    </div>
                                    ...
                                    <div class="flex items-center gap-2 mt-4 sm:mt-0">
                                        <div class="flex items-center border border-gray-300 rounded-md">
                                            ...
                                            <span class="px-3 py-1"><?php echo e($item->quantity); ?></span>
                    ...
                    <div class="flex justify-between mt-6">
                        <a href="<?php echo e(route('buy')); ?>" class="text-indigo-600 hover:text-indigo-800 transition flex items-center">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6 sticky top-6">
                        ...
                        <div class="space-y-3 mb-6">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span>$<?php echo e(number_format($total * 0.1, 2)); ?></span>
                            </div>
                            <div class="border-t pt-3 mt-3">
                                <div class="flex justify-between font-semibold">
                                    <span>Total</span>
                                    <span id="total-price" class="text-indigo-600">$<?php echo e(number_format($total * 1.1, 2)); ?></span>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function updateQuantity(cartId, change) {
            ...
            fetch('<?php echo e(route('cart.update-quantity')); ?>', {
                method: 'POST',
                headers: {
...
<?php endif; ?> <?php /**PATH C:\Users\charb\Downloads\modern_ct_zone\resources\views/cart.blade.php ENDPATH**/ ?>