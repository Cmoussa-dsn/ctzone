            ...
            <div class="rounded-xl overflow-hidden shadow-lg transition-transform duration-300 hover:shadow-xl hover:-translate-y-1">
                ...
                <div class="p-6 bg-white">
                    ...
                    <div class="mt-4 text-center">
                        <a href="{{ route('mining.index') }}" class="inline-block px-4 py-2 bg-amber-600 hover:bg-amber-700 rounded-lg text-white font-medium transition duration-300">Explore Mining</a>
                    </div>
                </div>
            </div>
        </div>
