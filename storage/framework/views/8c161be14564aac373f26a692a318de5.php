...
<?php $component->withAttributes([]); ?>
        ...
        <div class="container mx-auto px-6 py-24 md:py-32 relative z-10">
            <div class="max-w-3xl">
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="<?php echo e(route('pc-builder')); ?>" class="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 rounded-lg text-white font-semibold transition duration-300">Build Your PC</a>
                    <a href="<?php echo e(route('buy')); ?>" class="px-6 py-3 bg-white hover:bg-gray-100 rounded-lg text-indigo-700 font-semibold transition duration-300">Shop Pre-Built PCs</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container mx-auto px-6 py-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <!-- Card 4 (New Mining Card) -->
            <div class="rounded-xl overflow-hidden shadow-lg transition-transform duration-300 hover:shadow-xl hover:-translate-y-1">
                <div class="bg-amber-600 p-6 text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 mb-4" viewBox="0 0 20 20" fill="currentColor">
                        <path d="M11 17a1 1 0 001.447.894l4-2A1 1 0 0017 15V9.236a1 1 0 00-1.447-.894l-4 2a1 1 0 00-.553.894V17zM15.211 6.276a1 1 0 000-1.788l-4.764-2.382a1 1 0 00-.894 0L4.789 4.488a1 1 0 000 1.788l4.764 2.382a1 1 0 00.894 0l4.764-2.382zM4.447 8.342A1 1 0 003 9.236V15a1 1 0 00.553.894l4 2A1 1 0 009 17v-5.764a1 1 0 00-.553-.894l-4-2z" />
                    </svg>
                    <h3 class="text-xl font-bold mb-2">Crypto Mining</h3>
                    <p class="mb-4">Professional mining equipment and solutions to maximize your crypto profits.</p>
                </div>
                <div class="p-6 bg-white">
                    <ul class="space-y-2 text-gray-700">
                        <li class="flex items-center">
                    ...
                    <div class="mt-4 text-center">
                        <a href="<?php echo e(route('mining.index')); ?>" class="inline-block px-4 py-2 bg-amber-600 hover:bg-amber-700 rounded-lg text-white font-medium transition duration-300">Explore Mining</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container mx-auto px-6 py-16">
            <div class="flex flex-col md:flex-row items-center justify-between">
                <div class="md:w-1/2 mb-8 md:mb-0">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <a href="<?php echo e(route('login')); ?>" class="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 rounded-lg text-white font-semibold transition duration-300">Get Started</a>
                ...
                <div class="md:w-5/12">
                    <img src="<?php echo e(asset('images/gpu.webp')); ?>" alt="Modern PC Components" class="rounded-lg shadow-xl">
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="contact-form" class="container mx-auto px-6 py-16">
        ...
        <form method="POST" action="<?php echo e(route('home')); ?>" class="max-w-xl mx-auto">
            <?php echo csrf_field(); ?>
...
<?php endif; ?> <?php /**PATH C:\Users\charb\Downloads\modern_ct_zone (2)\modern_ct_zone\resources\views/home.blade.php ENDPATH**/ ?>