...
<head>
    ...
    <title>@yield('title', 'Admin Panel') - CT ZONE</title>
    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-20 md:w-64 bg-white/80 glass shadow-lg flex flex-col py-8 px-2 md:px-4">
            <nav class="flex flex-col gap-2">
                ...
                <a href="{{ route('admin.contacts.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg transition {{ request()->routeIs('admin.contacts.*') ? 'bg-green-500 text-white shadow' : 'text-gray-700 hover:bg-green-100' }}">
